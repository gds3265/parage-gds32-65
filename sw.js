const C='parage-v3-1-2';
const FILES=['./','index.html','style.css','app.js','manifest.json','app-logo.png','icon-192.png','icon-512.png','apple-touch-icon.png','favicon.png','assets/logo-gds.png','assets/logo-gds.jpg','clients.json'];
